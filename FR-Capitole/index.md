...
| date_created              | 2021-04-07 14:04:31                                                                                                                                                                                                                                                                                        |
...
| comment                   | Observation height varied depending on windspeed. All observations at lowest tower position (~27m) excluded, with wind speed corrected using log laws, following Goret et al. (2019) https://doi.org/10.1016/j.aeaoa.2019.100042. ERA5 snowfall set to zero during analysis period per advice from Masson. |
...
|   15 | roughness_length_momentum          |     0.39   | m             | estimated, see notes      | derived from morphology using [Kanda et al. (2013)](https://doi.org/10.1007/s10546-013-9818-x)                  |
|   16 | displacement_height                |    23.37   | m             | estimated, see notes      | derived from morphology using [Kanda et al. (2013)](https://doi.org/10.1007/s10546-013-9818-x)                  |
